<?php
$CI=&get_instance();
//$CI->load->model("deudas/Deudas");
@$cartera=$this->session->userdata('logged_in')["usuario"]->USU_CARTERA;

    $pagination = 10;
    $config['base_url'] = base_url().'modu/load/deudas/index';
    $config['total_rows'] = 4;//$CI->Deudas->total_rows($cartera);
 ...
 */
  ...
  //  $listado=$CI->Deudas->obtener_listado($cartera,$pagination, $paginacion);
    ?>
<!-- top navigation -->
            <div class="top_nav">
...
<div class="x_panel">
                                    ...
                                    <table class="table table-striped responsive-utilities jambo_table bulk_action">
                                        <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Deudor </th>
                                                <th class="column-title">Operación</th>
                                                <th class="column-title">Cuota</th>
                                                <th class="column-title">Vencimiento</th>
                                                <th class="column-title">Monto Total</th>
                                                <th class="column-title">Tipo de deuda</th>
                                                <th class="column-title">Tipo de deudor</th>
                                                <th class="column-title">Cedente</th>
                                                <th class="column-title">Registrar Atención</th>
                                                <th class="column-title no-link last"><span class="nobr">Ver Factura</span>
                                                </th>
                            ...
                            <tbody class="lista_deudores">
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><a class="info_deudor" href="#" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg" rut="<?= $value->DEU_CLI_RUT ?>"><?= $value->DEU_CLI_RUT ?></a></td>
                                    <td class=" "><?= $value->DEU_OPERACION ?></td>
                                    <td class=" "><?= $value->DEU_CUOTA ?></td>
                                    <td class=" "><?= $value->DEU_VENCIMIENTO ?></td>
                                    <td class=" "><i class="fa fa-dollar"></i> <?= number_format($value->DEU_MONTO_TOTAL_CUOTA, 0, '', '.');   ?></td>
                                    <td class="a-right a-right "><?= $value->TIPO_NOMBRE ?></td>
                                    <td class=" last"><?= $value->TI_NOMBRE ?></td>
                                    <td class=" last"><?= $value->CED_NOMBRE ?></td>
                                    <td class=" last"><a class="registrar_atencion btn btn-info" href="#" data-toggle="modal" data-target=".bs-registrar-modal-lg" rut="<?= $value->DEU_CLI_RUT ?>" deuda_id="<?= $value->DEU_ID ?>" operacion="<?= $value->DEU_OPERACION ?>"><i class="fa fa-edit"></i> </a></td>
                                    <td class=" last"><a class="ver_documento btn btn-default" href="#" data-toggle="modal" data-target=".bs-ver-documento-modal-lg" rut="<?= $value->DEU_CLI_RUT ?>"><i class="fa fa-eye"></i> </a></td>
                               </tr>
